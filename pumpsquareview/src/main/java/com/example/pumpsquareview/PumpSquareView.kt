...
class PumpSquareView(ctx : Context) : View(ctx) {
    ...
    data class PumpSquare(var i : Int) {

        private var curr : PSNode = PSNode(i)
    ...
    data class Renderer(var view : PumpSquareView) {

        private val ps : PumpSquare = PumpSquare(0)
